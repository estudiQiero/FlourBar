...
function pisosTotales(e) {
  ...
  // NO FUNCIONA - pulsacion de tecla enter para confirmar envio de datos.
...
function barraProgreso() {
  ...
  let ventas = 0;
  const campoVacio = document.getElementById("pisosVendidos").innerHTML;
  const obtenValorCampo = document.querySelector("#pisosVendidos").value;
  ...
  if (totalPisosVendidos === 0) {
    ...
    // Si el total de pisos vendidos es más de 1
